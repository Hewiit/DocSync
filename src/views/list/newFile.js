  ...
  methods: {
    ...
    deleteItem(item) {
      if (item.power === 'Creator') {
        this.$confirm('This operation will permanently dissolve the team. Continue?', 'Warning', {
          ...
          this.$message({
            type: 'info',
            message: 'Dissolution cancelled'
          });
        });
      } else {
        this.$confirm('This operation will exit the team. Continue?', 'Warning', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
    ...
    deleteMultiItem() {
      this.$confirm('This operation will permanently dissolve or exit all selected teams. Continue?', 'Warning', {
        confirmButtonText: 'Confirm',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
        ...
        this.$message({
          type: 'info',
          message: 'Dissolution or exit cancelled'
        });
      });
    },
    disbandTeam(item) {
